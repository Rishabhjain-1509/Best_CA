<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherContactPage.aspx.cs" Inherits="TeacherContactPage" %>
                        ...
                        <table>
                           ...
                           <tr>
                                <td style=" height:100px;">
                                   <a href="map.aspx" style="color:rgba(15,15,15,0.7); font-weight:bold;">   <input type="button" ID="Button1" runat="server" value="VIEW ON MAP" style=" Height:40px; Width:200px;  Font-Size:14px; border-radius:5px; border:none; "/> </a></td>
                            </tr>
                            <tr>
